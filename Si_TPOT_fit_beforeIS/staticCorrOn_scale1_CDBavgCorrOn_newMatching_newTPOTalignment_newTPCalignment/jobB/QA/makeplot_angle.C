...
void makeplot_angle()
{
  ...
  for (int k=0; k<nrun; k++)
  {
    ...
    //for (int i=0; i<200; i++) {intree->Add(Form("../../to_be_deleted/Reconstructed/%d/clusters_seeds_%d-%d-0.root_qa.root",runs[k],runs[k],i));}
    ...
    TH1* h1_tanAlpha = new TH1F("h1_tanAlpha","tanAlpha; tanAlpha; Entries",100,-10e-3,10e-3);
