    ...
    const bool convertSeeds = false)
{
  ...
  */
  ...
  else
  {
    ...
    const TString weighted_fitter_outfile = theOutfile + "_SiliconTpotWeightedFitter.root";
    ...
    auto silicon_tpot_weighted_fitter = new WeightedFitter("SiliconTpotWeightedFitter");
    ...
    silicon_tpot_weighted_fitter->set_track_map_node_name("SiliconMMWeightedFitterSvtxTrackMap");
    silicon_tpot_weighted_fitter->set_alignment_map_node_name("SiliconMMWeightedFitterAlignmentStateMap");
    silicon_tpot_weighted_fitter->set_weighted_track_map_node_name("SiliconMMWeightedFitterTrackMap");
  ...
  if (G4TRACKING::SC_CALIBMODE)
  {
    ...
    */
    ...
    residuals->setTrackMapName("SiliconMMWeightedFitterSvtxTrackMap");
  ...
  if(G4TRACKING::SC_CALIBMODE && !G4TRACKING::convert_seeds_to_svtxtracks)
  {
    ...
    resid->trackmapName("SiliconMMWeightedFitterSvtxTrackMap");
