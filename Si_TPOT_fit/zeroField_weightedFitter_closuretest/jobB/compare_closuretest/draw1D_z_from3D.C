...
TFile* ifile_withAvgCorr_dr = new TFile(Form("../Rootfiles/hist_dr_1Dz_R%d.root",(int)selectR),"");
...
TFile* ifile_withAvgCorr_rdphi = new TFile(Form("../Rootfiles/hist_rdphi_1Dz_R%d.root",(int)selectR),"");
...
TFile* ifile_withAvgCorr_dz = new TFile(Form("../Rootfiles/hist_dz_1Dz_R%d.root",(int)selectR),"");
...
TFile* ifile_noAvgCorr_dr = new TFile(Form("../../../zeroField_weightedFitter/jobB/Rootfiles/hist_dr_1Dz_R%d.root",(int)selectR),"");
...
TFile* ifile_noAvgCorr_rdphi = new TFile(Form("../../../zeroField_weightedFitter/jobB/Rootfiles/hist_rdphi_1Dz_R%d.root",(int)selectR),"");
...
TFile* ifile_noAvgCorr_dz = new TFile(Form("../../../zeroField_weightedFitter/jobB/Rootfiles/hist_dz_1Dz_R%d.root",(int)selectR),"");
