...
for (int i = 0; i < nrun; i++)
{
  ...
  h_P_pos_method1[i] = new TH1F(Form("hIntDistortionP_posz_%d",runs[i]),Form("Rdphi @ R=%d cm;Z (cm);Rdphi (cm)",(int)selectR),h_P_prz_pos_method1[i]->GetZaxis()->GetNbins(),h_P_prz_pos_method1[i]->GetZaxis()->GetXmin(),h_P_prz_pos_method1[i]->GetZaxis()->GetXmax());
  ...
  h_P_neg_method1[i] = new TH1F(Form("hIntDistortionP_negz_%d",runs[i]),Form("Rdphi @ R=%d cm;Z (cm);Rdphi (cm)",(int)selectR),h_P_prz_neg_method1[i]->GetZaxis()->GetNbins(),h_P_prz_neg_method1[i]->GetZaxis()->GetXmin(),h_P_prz_neg_method1[i]->GetZaxis()->GetXmax());
  ...
  plot1D_Zbin(h_P_prz_pos_method1[i],h_P_pos_method1[i],selectR,true);
  ...
  plot1D_Zbin(h_P_prz_neg_method1[i],h_P_neg_method1[i],selectR,true);
  ...
  h_P_pos_method2[i] = new TH1F(Form("hIntDistortionP_posz_%d",runs[i]),Form("Rdphi @ R=%d cm;Z (cm);Rdphi (cm)",(int)selectR),h_P_prz_pos_method2[i]->GetZaxis()->GetNbins(),h_P_prz_pos_method2[i]->GetZaxis()->GetXmin(),h_P_prz_pos_method2[i]->GetZaxis()->GetXmax());
  ...
  h_P_neg_method2[i] = new TH1F(Form("hIntDistortionP_negz_%d",runs[i]),Form("Rdphi @ R=%d cm;Z (cm);Rdphi (cm)",(int)selectR),h_P_prz_neg_method2[i]->GetZaxis()->GetNbins(),h_P_prz_neg_method2[i]->GetZaxis()->GetXmin(),h_P_prz_neg_method2[i]->GetZaxis()->GetXmax());
  ...
  plot1D_Zbin(h_P_prz_pos_method2[i],h_P_pos_method2[i],selectR,true);
  ...
  plot1D_Zbin(h_P_prz_neg_method2[i],h_P_neg_method2[i],selectR,true);
  ...
  h_P_pos_method3[i] = new TH1F(Form("hIntDistortionP_posz_%d",runs[i]),Form("Rdphi @ R=%d cm;Z (cm);Rdphi (cm)",(int)selectR),h_P_prz_pos_method3[i]->GetZaxis()->GetNbins(),h_P_prz_pos_method3[i]->GetZaxis()->GetXmin(),h_P_prz_pos_method3[i]->GetZaxis()->GetXmax());
  ...
  h_P_neg_method3[i] = new TH1F(Form("hIntDistortionP_negz_%d",runs[i]),Form("Rdphi @ R=%d cm;Z (cm);Rdphi (cm)",(int)selectR),h_P_prz_neg_method3[i]->GetZaxis()->GetNbins(),h_P_prz_neg_method3[i]->GetZaxis()->GetXmin(),h_P_prz_neg_method3[i]->GetZaxis()->GetXmax());
  ...
  plot1D_Zbin(h_P_prz_pos_method3[i],h_P_pos_method3[i],selectR,true);
  ...
  plot1D_Zbin(h_P_prz_neg_method3[i],h_P_neg_method3[i],selectR,true);
  ...
  std::pair<double,double> yrange_R = SetCommonYRange({h_R_neg_method1[i], h_R_pos_method1[i], h_R_neg_method2[i], h_R_pos_method2[i], h_R_neg_method3[i], h_R_pos_method3[i]});
  std::pair<double,double> yrange_P = SetCommonYRange({h_P_neg_method1[i], h_P_pos_method1[i], h_P_neg_method2[i], h_P_pos_method2[i], h_P_neg_method3[i], h_P_pos_method3[i]});
  std::pair<double,double> yrange_Z = SetCommonYRange({h_Z_neg_method1[i], h_Z_pos_method1[i], h_Z_neg_method2[i], h_Z_pos_method2[i], h_Z_neg_method3[i], h_Z_pos_method3[i]});
