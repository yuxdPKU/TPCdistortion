...
for (int i = 0; i < nrun; i++)
{
  file_3D_map_method1[i] = new TFile(Form("../../run3pp_newSiFieldonAlignment_newTPOTzfAlignment/jobB/Rootfiles/Distortions_full_mm_%d.root",runs[i]),"");
  ...
  file_3D_map_method2[i] = new TFile(Form("../../run3pp_newSiFieldonAlignment_newTPOTzfAlignment_disableOtherCorr/jobB/Rootfiles/Distortions_full_mm_%d.root",runs[i]),"");
  ...
  file_3D_map_method3[i] = new TFile(Form("/sphenix/u/hangal/Public/forXudong/dc_distortions_run%d/_0p9.distortion_map.hist.root",runs[i]),"");
  ...
  h_P_pos_method3[i] = new TH1F(Form("hIntDistortionP_posz_%d",runs[i]),Form("dphi @ Z=%d cm;R (cm);dphi (rad)",(int)selectZ),h_P_prz_pos_method3[i]->GetYaxis()->GetNbins(),h_P_prz_pos_method3[i]->GetYaxis()->GetXmin(),h_P_prz_pos_method3[i]->GetYaxis()->GetXmax());
  ...
  h_P_neg_method3[i] = new TH1F(Form("hIntDistortionP_negz_%d",runs[i]),Form("dphi @ Z=-%d cm;R (cm);dphi (rad)",(int)selectZ),h_P_prz_neg_method3[i]->GetYaxis()->GetNbins(),h_P_prz_neg_method3[i]->GetYaxis()->GetXmin(),h_P_prz_neg_method3[i]->GetYaxis()->GetXmax());
  ...
  plot1D_Zbin(h_P_prz_pos_method3[i],h_P_pos_method3[i],selectZ, false);
  ...
  plot1D_Zbin(h_P_prz_neg_method3[i],h_P_neg_method3[i],-selectZ, false);
  plot1D_Zbin(h_Z_prz_neg_method3[i],h_Z_neg_method3[i],-selectZ, false);
  //h_N_pos_method3[i]->SetLineColor(6); h_N_pos_method3[i]->SetLineWidth(1); h_N_pos_method3[i]->SetFillColor(0); h_N_pos_method3[i]->SetMarkerColor(6);
  h_R_pos_method3[i]->SetLineColor(6); h_R_pos_method3[i]->SetLineWidth(1); h_R_pos_method3[i]->SetFillColor(0); h_R_pos_method3[i]->SetMarkerColor(6);
  h_P_pos_method3[i]->SetLineColor(6); h_P_pos_method3[i]->SetLineWidth(1); h_P_pos_method3[i]->SetFillColor(0); h_P_pos_method3[i]->SetMarkerColor(6);
  h_Z_pos_method3[i]->SetLineColor(6); h_Z_pos_method3[i]->SetLineWidth(1); h_Z_pos_method3[i]->SetFillColor(0); h_Z_pos_method3[i]->SetMarkerColor(6);
  //h_N_neg_method3[i]->SetLineColor(6); h_N_neg_method3[i]->SetLineWidth(1); h_N_neg_method3[i]->SetFillColor(0); h_R_neg_method3[i]->SetMarkerColor(6);
  h_R_neg_method3[i]->SetLineColor(6); h_R_neg_method3[i]->SetLineWidth(1); h_R_neg_method3[i]->SetFillColor(0); h_R_neg_method3[i]->SetMarkerColor(6);
  h_P_neg_method3[i]->SetLineColor(6); h_P_neg_method3[i]->SetLineWidth(1); h_P_neg_method3[i]->SetFillColor(0); h_P_neg_method3[i]->SetMarkerColor(6);
  h_Z_neg_method3[i]->SetLineColor(6); h_Z_neg_method3[i]->SetLineWidth(1); h_Z_neg_method3[i]->SetFillColor(0); h_Z_neg_method3[i]->SetMarkerColor(6);
...
for (int i=0; i<nrun; i++)
{
	...
	//hists_P.push_back(hcdb_P_pos[i]);
	//hists_P.push_back(hcdb_P_neg[i]);
}
for (int i=0; i<nrun; i++)
{
	...
	//hists_R.push_back(hcdb_R_pos[i]);
	//hists_R.push_back(hcdb_R_neg[i]);
}
for (int i=0; i<nrun; i++)
{
	...
	//hists_Z.push_back(hcdb_Z_pos[i]);
	//hists_Z.push_back(hcdb_Z_neg[i]);
}
...
//legend->AddEntry(h_P_pos_method1[i], Form("Module-edge & Static on"), "l");
legend->AddEntry(h_P_pos_method2[i], Form("TPOT Module-edge & Static off"), "l");
legend->AddEntry(h_P_pos_method3[i], Form("DC static + space-charge"), "l");
legend->Draw();
TCanvas* can_leg = new TCanvas("can_leg","",2500,1000);
legend->Draw();
