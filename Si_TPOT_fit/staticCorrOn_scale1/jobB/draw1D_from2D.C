...
TFile* file_2D_map[7];
TH2 *h_N_rz_pos[7], *h_R_rz_pos[7], *h_P_rz_pos[7], *h_Z_rz_pos[7], *h_RP_rz_pos[7];
TH2 *h_N_rz_neg[7], *h_R_rz_neg[7], *h_P_rz_neg[7], *h_Z_rz_neg[7], *h_RP_rz_neg[7];
TH1 *h_N_pos[7], *h_R_pos[7], *h_P_pos[7], *h_Z_pos[7], *h_RP_pos[7];
TH1 *h_N_neg[7], *h_R_neg[7], *h_P_neg[7], *h_Z_neg[7], *h_RP_neg[7];
...
if (ymax_N>0) ymax_N *= 1.1; else ymax_N = 0.1;
...
if (ymin_N<0) ymin_N *= 1.1; else ymin_N = -0.1;
