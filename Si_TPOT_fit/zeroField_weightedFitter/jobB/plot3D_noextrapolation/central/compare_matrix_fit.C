...
for (int i = 0; i < nrun; i++)
{
  ...
  std::pair<double,double> yrange_R = SetCommonYRange({h_R_rphi_pos[i],h_R_zr_pos[i],h_R_rphi_neg[i],h_R_zr_neg[i],hfit_R_rphi_pos[i],hfit_R_zr_pos[i],hfit_R_rphi_neg[i],hfit_R_zr_neg[i]});
  std::pair<double,double> yrange_P = SetCommonYRange({h_P_rphi_pos[i],h_P_rphi_neg[i],hfit_P_pos[i],hfit_P_neg[i]});
  std::pair<double,double> yrange_Z = SetCommonYRange({h_Z_zr_pos[i],h_Z_zr_neg[i],hfit_Z_pos[i],hfit_Z_neg[i]});
