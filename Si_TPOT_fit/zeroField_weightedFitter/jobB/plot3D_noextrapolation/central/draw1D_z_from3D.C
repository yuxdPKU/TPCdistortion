...
// 52077 - 400khz 4758.536231884057
...
for (int i = 0; i < nrun; i++)
{
  ...
  std::pair<double,double> yrange_R_neg = SetCommonYRange({h_R_neg[i],h_R_neg_phi[i],h_R_neg_z[i]});
  std::pair<double,double> yrange_R_pos = SetCommonYRange({h_R_pos[i],h_R_pos_phi[i],h_R_pos_z[i]});
  std::pair<double,double> yrange_P_neg = SetCommonYRange({h_P_neg[i],h_P_neg_phi[i],h_P_neg_z[i]});
  std::pair<double,double> yrange_P_pos = SetCommonYRange({h_P_pos[i],h_P_pos_phi[i],h_P_pos_z[i]});
  std::pair<double,double> yrange_Z_neg = SetCommonYRange({h_Z_neg[i],h_Z_neg_phi[i],h_Z_neg_z[i]});
  std::pair<double,double> yrange_Z_pos = SetCommonYRange({h_Z_pos[i],h_Z_pos_phi[i],h_Z_pos_z[i]});
  ...
  l_nco_o_R[i] = new TLine(selectR*tan(thetarange_NCO.second),yrange_R_pos.first,selectR*tan(thetarange_NCO.second),yrange_R_pos.second);
  l_nco_o_P[i] = new TLine(selectR*tan(thetarange_NCO.second),yrange_P_pos.first,selectR*tan(thetarange_NCO.second),yrange_P_pos.second);
  l_nco_o_Z[i] = new TLine(selectR*tan(thetarange_NCO.second),yrange_Z_pos.first,selectR*tan(thetarange_NCO.second),yrange_Z_pos.second);
  ...
  l_nco_i_R[i] = new TLine(selectR*tan(thetarange_NCO.first),yrange_R_pos.first,selectR*tan(thetarange_NCO.first),yrange_R_pos.second);
  l_nco_i_P[i] = new TLine(selectR*tan(thetarange_NCO.first),yrange_P_pos.first,selectR*tan(thetarange_NCO.first),yrange_P_pos.second);
  l_nco_i_Z[i] = new TLine(selectR*tan(thetarange_NCO.first),yrange_Z_pos.first,selectR*tan(thetarange_NCO.first),yrange_Z_pos.second);
  //l_nco_i_RP[i] = new TLine(selectR*tan(thetarange_NCO.first),yrange_RP_pos.first,selectR*tan(thetarange_NCO.first),yrange_RP_pos.second);

  l_nci_o_R[i] = new TLine(selectR*tan(thetarange_NCI.second),yrange_R_pos.first,selectR*tan(thetarange_NCI.second),yrange_R_pos.second);
  l_nci_o_P[i] = new TLine(selectR*tan(thetarange_NCI.second),yrange_P_pos.first,selectR*tan(thetarange_NCI.second),yrange_P_pos.second);
  l_nci_o_Z[i] = new TLine(selectR*tan(thetarange_NCI.second),yrange_Z_pos.first,selectR*tan(thetarange_NCI.second),yrange_Z_pos.second);
  ...
  l_nci_i_R[i] = new TLine(selectR*tan(thetarange_NCI.first),yrange_R_pos.first,selectR*tan(thetarange_NCI.first),yrange_R_pos.second);
  l_nci_i_P[i] = new TLine(selectR*tan(thetarange_NCI.first),yrange_P_pos.first,selectR*tan(thetarange_NCI.first),yrange_P_pos.second);
  l_nci_i_Z[i] = new TLine(selectR*tan(thetarange_NCI.first),yrange_Z_pos.first,selectR*tan(thetarange_NCI.first),yrange_Z_pos.second);
  ...
  l_sci_i_R[i] = new TLine(selectR*tan(thetarange_SCI.second),yrange_R_neg.first,selectR*tan(thetarange_SCI.second),yrange_R_neg.second);
  l_sci_i_P[i] = new TLine(selectR*tan(thetarange_SCI.second),yrange_P_neg.first,selectR*tan(thetarange_SCI.second),yrange_P_neg.second);
  l_sci_i_Z[i] = new TLine(selectR*tan(thetarange_SCI.second),yrange_Z_neg.first,selectR*tan(thetarange_SCI.second),yrange_Z_neg.second);
  ...
  l_sci_o_R[i] = new TLine(selectR*tan(thetarange_SCI.first),yrange_R_neg.first,selectR*tan(thetarange_SCI.first),yrange_R_neg.second);
  l_sci_o_P[i] = new TLine(selectR*tan(thetarange_SCI.first),yrange_P_neg.first,selectR*tan(thetarange_SCI.first),yrange_P_neg.second);
  l_sci_o_Z[i] = new TLine(selectR*tan(thetarange_SCI.first),yrange_Z_neg.first,selectR*tan(thetarange_SCI.first),yrange_Z_neg.second);
  ...
  l_sco_i_R[i] = new TLine(selectR*tan(thetarange_SCO.second),yrange_R_neg.first,selectR*tan(thetarange_SCO.second),yrange_R_neg.second);
  l_sco_i_P[i] = new TLine(selectR*tan(thetarange_SCO.second),yrange_P_neg.first,selectR*tan(thetarange_SCO.second),yrange_P_neg.second);
  l_sco_i_Z[i] = new TLine(selectR*tan(thetarange_SCO.second),yrange_Z_neg.first,selectR*tan(thetarange_SCO.second),yrange_Z_neg.second);
  ...
  l_sco_o_R[i] = new TLine(selectR*tan(thetarange_SCO.first),yrange_R_neg.first,selectR*tan(thetarange_SCO.first),yrange_R_neg.second);
  l_sco_o_P[i] = new TLine(selectR*tan(thetarange_SCO.first),yrange_P_neg.first,selectR*tan(thetarange_SCO.first),yrange_P_neg.second);
  l_sco_o_Z[i] = new TLine(selectR*tan(thetarange_SCO.first),yrange_Z_neg.first,selectR*tan(thetarange_SCO.first),yrange_Z_neg.second);
...
for (int i=0; i<nrun; i++) legend->AddEntry(h_P_pos[i], Form("Run %d",runs[i]), "l");
for (int i=0; i<nrun; i++) legend->AddEntry(h_P_pos_phi[i], Form("Run %d (phi)",runs[i]), "l");
for (int i=0; i<nrun; i++) legend->AddEntry(h_P_pos_z[i], Form("Run %d (z)",runs[i]), "l");
legend->Draw();
