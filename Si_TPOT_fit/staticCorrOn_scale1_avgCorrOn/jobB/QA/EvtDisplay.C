...
void EvtDisplay()
{
  ...
  TFile* infile = new TFile(Form("~/workarea/TPCdistortion/Si_TPOT_fit/staticCorrOn_scale1_avgCorrOn/Reconstructed/%d/clusters_seeds_%d-%d.root_qa.root",runno,runno,segmentno));
