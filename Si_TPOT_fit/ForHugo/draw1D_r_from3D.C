...
for (int i = 0; i < nrun; i++)
{
  file_3D_map[i] = new TFile(Form("/direct/phenix+u/workarea/hpereira/sphenix/work/g4simulations/Rootfiles/Distortions-000%d_CombinedDataReconstruction-new.root",runs[i]),"");
