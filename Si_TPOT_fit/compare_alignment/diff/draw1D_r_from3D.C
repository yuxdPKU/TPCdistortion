...
TH1 *h_N_pos_diff[nrun], *h_R_pos_diff[nrun], *h_P_pos_diff[nrun], *h_Z_pos_diff[nrun];
TH1 *h_N_neg_diff[nrun], *h_R_neg_diff[nrun], *h_P_neg_diff[nrun], *h_Z_neg_diff[nrun];
...
for (int i = 0; i < nrun; i++)
{
  ...
  */
  ...
  h_R_pos_diff[i] = SubtractHistograms(h_R_pos_method3[i], h_R_pos_method1[i], "R_pos_diff");
  h_R_neg_diff[i] = SubtractHistograms(h_R_neg_method3[i], h_R_neg_method1[i], "R_neg_diff");
  h_P_pos_diff[i] = SubtractHistograms(h_P_pos_method3[i], h_P_pos_method1[i], "P_pos_diff");
  h_P_neg_diff[i] = SubtractHistograms(h_P_neg_method3[i], h_P_neg_method1[i], "P_neg_diff");
  h_Z_pos_diff[i] = SubtractHistograms(h_Z_pos_method3[i], h_Z_pos_method1[i], "Z_pos_diff");
  h_Z_neg_diff[i] = SubtractHistograms(h_Z_neg_method3[i], h_Z_neg_method1[i], "Z_neg_diff");

  h_R_pos_diff[i]->SetLineColor(6); h_R_pos_diff[i]->SetLineWidth(1); h_R_pos_diff[i]->SetFillColor(0); h_R_pos_diff[i]->SetMarkerColor(6);
  h_P_pos_diff[i]->SetLineColor(6); h_P_pos_diff[i]->SetLineWidth(1); h_P_pos_diff[i]->SetFillColor(0); h_P_pos_diff[i]->SetMarkerColor(6);
  h_Z_pos_diff[i]->SetLineColor(6); h_Z_pos_diff[i]->SetLineWidth(1); h_Z_pos_diff[i]->SetFillColor(0); h_Z_pos_diff[i]->SetMarkerColor(6);
  h_R_neg_diff[i]->SetLineColor(6); h_R_neg_diff[i]->SetLineWidth(1); h_R_neg_diff[i]->SetFillColor(0); h_R_neg_diff[i]->SetMarkerColor(6);
  h_P_neg_diff[i]->SetLineColor(6); h_P_neg_diff[i]->SetLineWidth(1); h_P_neg_diff[i]->SetFillColor(0); h_P_neg_diff[i]->SetMarkerColor(6);
  h_Z_neg_diff[i]->SetLineColor(6); h_Z_neg_diff[i]->SetLineWidth(1); h_Z_neg_diff[i]->SetFillColor(0); h_Z_neg_diff[i]->SetMarkerColor(6);
...
h_P_pos_diff[i]->Draw("hist,e,same");
can->cd(2);
gPad->SetLogy(0);
...
h_R_pos_diff[i]->Draw("hist,e,same");
can->cd(3);
gPad->SetLogy(0);
...
h_Z_pos_diff[i]->Draw("hist,e,same");
can->cd(4);
gPad->SetLogy(0);
...
h_P_neg_diff[i]->Draw("hist,e,same");
can->cd(5);
gPad->SetLogy(0);
...
h_R_neg_diff[i]->Draw("hist,e,same");
can->cd(6);
gPad->SetLogy(0);
...
h_Z_neg_diff[i]->Draw("hist,e,same");
