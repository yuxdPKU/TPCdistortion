...
for (int i=0; i<nrun; i++)
{
	...
	*/
	hists_P.push_back(h_P_neg_diff[i]);
	hists_P.push_back(h_P_pos_diff[i]);
}
for (int i=0; i<nrun; i++)
{
	/*
	...
	*/
	hists_R.push_back(h_R_neg_diff[i]);
	hists_R.push_back(h_R_pos_diff[i]);
}
for (int i=0; i<nrun; i++)
{
	/*
	...
	*/
	hists_Z.push_back(h_Z_neg_diff[i]);
	hists_Z.push_back(h_Z_pos_diff[i]);
}
