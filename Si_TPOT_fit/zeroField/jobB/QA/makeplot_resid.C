...
void makeplot_resid()
{
  ...
  for (int k=0; k<nrun; k++)
  {
    ...
    TH2* h2_drphi_layer = new TH2F("h2_drphi_layer","TPC RPhi residual vs layer; Layer; #delta r#phi (clus-state) (cm)",60,0,60,100,-2,2);
    ...
    */
    ...
    fit_gauss_Rslice(h2_drphi_layer, 1, Form("figure/%d_drphi_layer.pdf",runs[k]),1); 
    fit_gauss_Rslice(h2_dz_layer, 1, Form("figure/%d_dz_layer.pdf",runs[k]),1); 
