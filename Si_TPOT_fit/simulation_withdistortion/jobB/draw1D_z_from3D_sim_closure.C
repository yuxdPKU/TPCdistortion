...
draw1Dmap(Form("/phenix/u/hpereira/sphenix/work/g4simulations/distortion_maps/average_minus_static_distortion_converted.root"), Form("MI_sim_input"), selectR, selectPhi, hists_MI_sim_input, 1, true);
...
can->cd(2);
hists_MI_sim_truth.h_P_pos->SetMinimum(-0.01); hists_MI_sim_truth.h_P_pos->SetMaximum(0.01);
...
can->cd(4);
gPad->SetLogy(0);
hists_MI_sim_truth.h_Z_pos->SetMinimum(-1); hists_MI_sim_truth.h_Z_pos->SetMaximum(1);
...
can->cd(6);
hists_MI_sim_truth.h_P_neg->SetMinimum(-0.01); hists_MI_sim_truth.h_P_neg->SetMaximum(0.01);
...
can->cd(8);
gPad->SetLogy(0);
hists_MI_sim_truth.h_Z_neg->SetMinimum(-1); hists_MI_sim_truth.h_Z_neg->SetMaximum(1);
