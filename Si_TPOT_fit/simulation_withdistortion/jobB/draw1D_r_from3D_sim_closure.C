...
oneDHist hists_MI_sim_acts, hists_MI_sim_genfit, hists_MI_sim_truth, hists_MI_sim_input;
//draw1Dmap(Form("./Rootfiles/Distortions_full_mm_%d_MI_sim_reco_acts.root", run), Form("MI_sim_reco_acts"), selectZ, selectPhi, hists_MI_sim_acts, 2);
//draw1Dmap(Form("./Rootfiles/Distortions_full_mm_%d_MI_sim_reco_genfit.root", run), Form("MI_sim_reco_genfit"), selectZ, selectPhi, hists_MI_sim_genfit, 3);
draw1Dmap(Form("./Rootfiles/Distortions_full_mm_%d_MI_sim_reco_truth.root", run), Form("MI_sim_reco_truth"), selectZ, selectPhi, hists_MI_sim_truth, 4);
draw1Dmap(Form("/phenix/u/hpereira/sphenix/work/g4simulations/distortion_maps/average_minus_static_distortion_converted.root"), Form("MI_sim_input"), selectZ, selectPhi, hists_MI_sim_input, 1, true);
...
hists_P.push_back(hists_MI_sim_input.h_P_neg);
hists_P.push_back(hists_MI_sim_input.h_P_pos);
/*
...
hists_R.push_back(hists_MI_sim_input.h_R_neg);
hists_R.push_back(hists_MI_sim_input.h_R_pos);
/*
...
hists_Z.push_back(hists_MI_sim_input.h_Z_neg);
hists_Z.push_back(hists_MI_sim_input.h_Z_pos);
...
hists_MI_sim_input.h_N_pos->Write();
hists_MI_sim_input.h_N_neg->Write();
*/
ofile_N->Write();
...
hists_MI_sim_input.h_R_pos->Write();
hists_MI_sim_input.h_R_neg->Write();
ofile_R->Write();
...
hists_MI_sim_input.h_P_pos->Write();
hists_MI_sim_input.h_P_neg->Write();
ofile_P->Write();
...
hists_MI_sim_input.h_Z_pos->Write();
hists_MI_sim_input.h_Z_neg->Write();
ofile_Z->Write();
...
//hists_MI_sim_input.h_N_pos->Draw("hist,same");
can->cd(2);
hists_MI_sim_truth.h_P_pos->SetMinimum(-0.01); hists_MI_sim_truth.h_P_pos->SetMaximum(0.03);
...
hists_MI_sim_input.h_P_pos->Draw("hist,same");
can->cd(3);
gPad->SetLogy(0);
hists_MI_sim_truth.h_R_pos->SetMinimum(-0.5); hists_MI_sim_truth.h_R_pos->SetMaximum(0.5);
...
hists_MI_sim_input.h_R_pos->Draw("hist,same");
can->cd(4);
gPad->SetLogy(0);
hists_MI_sim_truth.h_Z_pos->SetMinimum(-0.1); hists_MI_sim_truth.h_Z_pos->SetMaximum(0.1);
...
hists_MI_sim_input.h_Z_pos->Draw("hist,same");
can->cd(5);
gPad->SetLogy(1);
...
//hists_MI_sim_input.h_N_neg->Draw("hist,same");
can->cd(6);
hists_MI_sim_truth.h_P_neg->SetMinimum(-0.01); hists_MI_sim_truth.h_P_neg->SetMaximum(0.03);
...
hists_MI_sim_input.h_P_neg->Draw("hist,same");
can->cd(7);
gPad->SetLogy(0);
hists_MI_sim_truth.h_R_neg->SetMinimum(-0.5); hists_MI_sim_truth.h_R_neg->SetMaximum(0.5);
...
hists_MI_sim_input.h_R_neg->Draw("hist,same");
can->cd(8);
gPad->SetLogy(0);
hists_MI_sim_truth.h_Z_neg->SetMinimum(-0.1); hists_MI_sim_truth.h_Z_neg->SetMaximum(0.1);
...
hists_MI_sim_input.h_Z_neg->Draw("hist,same");
...
legend->AddEntry(hists_MI_sim_input.h_P_pos, Form("INPUT"), "F");
legend->Draw();
