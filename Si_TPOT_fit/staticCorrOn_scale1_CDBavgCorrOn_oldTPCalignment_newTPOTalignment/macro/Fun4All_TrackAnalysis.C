...
void Fun4All_TrackAnalysis(
    ...
    const std::string clusterfilename = "DST_TRKR_CLUSTER_run2pp_ana505_2024p023_v001-00053877-00000.root",
    const std::string seedfilename = "DST_TRKR_SEED_run2pp_ana506_2024p023_v001-00053877-00000.root",
    ...
    const bool convertSeeds = false)
{
  ...
  std::string inputseedFile = seedfilename;
