...
h_R_pos_sim->SetMinimum(-2); h_R_pos_sim->SetMaximum(2);
h_P_pos_sim->SetMinimum(-0.01); h_P_pos_sim->SetMaximum(0.03);
h_Z_pos_sim->SetMinimum(-0.2); h_Z_pos_sim->SetMaximum(2);
h_RP_pos_sim->SetMinimum(-0.7); h_RP_pos_sim->SetMaximum(1.2);
...
h_R_neg_sim->SetMinimum(-2); h_R_neg_sim->SetMaximum(2);
h_P_neg_sim->SetMinimum(-0.01); h_P_neg_sim->SetMaximum(0.03);
h_Z_neg_sim->SetMinimum(-0.2); h_Z_neg_sim->SetMaximum(2);
h_RP_neg_sim->SetMinimum(-0.7); h_RP_neg_sim->SetMaximum(1.2);
...
for (int i=0; i<6; i++) legend->AddEntry(h_P_pos[i], Form("Run %d, MBD rate %d kHz",runs[i],mbdrates[i]), "l");
legend->Draw();
