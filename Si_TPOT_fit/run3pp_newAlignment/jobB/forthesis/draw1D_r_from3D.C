...
for (int i = 0; i < nrun; i++)
{
  ...
  plot1D_Zbin(h_P_prz_pos[i],h_P_pos[i],selectZ, false);
  ...
  plot1D_Zbin(h_P_prz_neg[i],h_P_neg[i],-selectZ, false);
...
for (int i=0; i<nrun; i++) { hists_P.push_back(h_P_pos[i]); hists_P.push_back(h_P_neg[i]); }//hists_P.push_back(hcdb_P_pos[i]); hists_P.push_back(hcdb_P_neg[i]); }
for (int i=0; i<nrun; i++) { hists_R.push_back(h_R_pos[i]); hists_R.push_back(h_R_neg[i]); }//hists_R.push_back(hcdb_R_pos[i]); hists_R.push_back(hcdb_R_neg[i]); }
for (int i=0; i<nrun; i++) { hists_Z.push_back(h_Z_pos[i]); hists_Z.push_back(h_Z_neg[i]); }//hists_Z.push_back(hcdb_Z_pos[i]); hists_Z.push_back(hcdb_Z_neg[i]); }
