...
//  -*- C++ -*-.
#ifndef DISTORTIONANALYSIS_H
#define DISTORTIONANALYSIS_H
...
class DistortionAnalysis : public SubsysReco
{
 public:
  DistortionAnalysis(const std::string &name = "DistortionAnalysis");

  ~DistortionAnalysis() override = default;
