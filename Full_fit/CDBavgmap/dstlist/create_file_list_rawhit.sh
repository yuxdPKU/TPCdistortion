...
do
  ...
  do
    ...
    do
      ...
      echo "DST_STREAMING_EVENT_${subsystem}${server}_${runspecies}_${anabuild}_${cdbtag}_${version}-000${runs[$k]}-${segment}.root" >> ${out}
    done
    ...
    do
      ...
      echo "DST_STREAMING_EVENT_${subsystem}${felix}_${runspecies}_${anabuild}_${cdbtag}_${version}-000${runs[$k]}-${segment}.root" >> ${out}
    done
    ...
    do
      ...
      echo "DST_STREAMING_EVENT_${subsystem}${ebdc}_${runspecies}_${anabuild}_${cdbtag}_${version}-000${runs[$k]}-${segment}.root" >> ${out}
    done
    ...
    echo "DST_STREAMING_EVENT_${subsystem}_${runspecies}_${anabuild}_${cdbtag}_${version}-000${runs[$k]}-${segment}.root" >> ${out}
