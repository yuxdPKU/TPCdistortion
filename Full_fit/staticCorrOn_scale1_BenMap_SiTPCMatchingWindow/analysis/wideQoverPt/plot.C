...
void plot()
{
  ...
  for (int k=0; k<nrun; k++)
  {
    ...
    */
    ...
    plot1D_QoverPt(h1_dz_QoverPt, chain, Form("m_tpcseedz-m_silseedz"), cut, Form("figure/%d_dz_allQoverPt",runs[k]), -10, 10, 0, 1);
    ...
    plot1D_QoverPt(h1_dz_etapos_QoverPt, chain, Form("m_tpcseedz-m_silseedz"), cut+"tpcseedeta>0", Form("figure/%d_dz_allQoverPt_etapos",runs[k]), -10, 10, 0);
    ...
    plot1D_QoverPt(h1_dz_etaneg_QoverPt, chain, Form("m_tpcseedz-m_silseedz"), cut+"tpcseedeta<0", Form("figure/%d_dz_allQoverPt_etaneg",runs[k]), -10, 10, 0);
    ...
    plot1D_QoverPt(h1_deta_QoverPt, chain, Form("m_tpcseedeta-m_silseedeta"), cut, Form("figure/%d_deta_allQoverPt",runs[k]), -0.3, 0.3, 0, 1);
...
void plot1D_QoverPt(TH1* h[], TChain* chain, TString name, TCut cut, TString output, double fit_xmin, double fit_xmax, bool logy=0, bool doexpfit=0)
{
    ...
    if (doexpfit)
    {
      ...
      //gr_3sigmawindow->SetMaximum(0.08);//for deta
      //gr_3sigmawindow->SetMinimum(0.01);//for deta
      gr_3sigmawindow->SetMaximum(2.7);//for dz
      gr_3sigmawindow->SetMinimum(1.1);//for dz
      gr_3sigmawindow->GetXaxis()->SetRangeUser(-2.5, 2.5);
