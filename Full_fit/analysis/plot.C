...
void plot()
{
  ...
  for (int k=0; k<nrun; k++)
  {
    ...
    TH1* h_quality_Ben = new TH1F("h_quality_Ben","quality;quality;Counts",30, 0,300);
    TH1* h_quality_Xudong = new TH1F("h_quality_Xudong","quality;quality;Counts",30, 0,300);
...
void plot1D(TH1* h_noavg, TH1* h_Ben, TH1* h_Xudong, TChain* chain_noavg, TChain* chain_Ben, TChain* chain_Xudong, TString name, TString output)
{
    ...
    TLegend *legend = new TLegend(0.52, 0.75, 0.72, 0.9);
