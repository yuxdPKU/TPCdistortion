void plot1D(TH1* h_100, TH1* h_1, TChain* chain_100, TChain* chain_1, TString name, TString output);

void plot_quality_misalignment()
{
  gStyle->SetOptStat(0);
  ...
  for (int k=0; k<nrun; k++)
  {
    ...
    TH1* h_quality_Misalignment100 = new TH1F("h_quality_Misalignment100","quality;quality;Counts",100, 0,300);
    TH1* h_quality_Misalignment1 = new TH1F("h_quality_Misalignment1","quality;quality;Counts",100, 0,300);
    TH1* h_quality_Misalignment1_blowupTPC = new TH1F("h_quality_Misalignment1_blowupTPC","quality;quality;Counts",100, 0,300);
    plot1D(h_quality_Misalignment100, h_quality_Misalignment1, h_quality_Misalignment1_blowupTPC, chain_Misalignment100, chain_Misalignment1, chain_Misalignment1, Form("quality"), Form("figure/%d_quality_Misalignment.pdf",runs[k]));
  }
}
