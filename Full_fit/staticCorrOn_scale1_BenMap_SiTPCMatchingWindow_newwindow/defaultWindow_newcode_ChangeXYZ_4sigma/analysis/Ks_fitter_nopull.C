...
void Ks_fitter_nopull()
{
  ...
  path = "/sphenix/u/xyu3/workarea/TPCdistortion/Full_fit/staticCorrOn_scale1_BenMap_SiTPCMatchingWindow_newwindow/defaultWindow_newcode_ChangeXYZ_4sigma/analysis/";
