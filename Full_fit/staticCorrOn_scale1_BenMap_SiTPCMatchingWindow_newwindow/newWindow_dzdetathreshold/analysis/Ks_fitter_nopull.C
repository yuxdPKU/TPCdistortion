...
void Ks_fitter_nopull()
{
  ...
  path = "/sphenix/u/xyu3/workarea/TPCdistortion/Full_fit/staticCorrOn_scale1_BenMap_SiTPCMatchingWindow_newwindow/newWindow_dzdetathreshold/analysis/";
  ...
  */
  ...
  RooRealVar nBkg("nBkg", "nBkg", 0.3*dataSet.sumEntries(), 0, 1e8);
