  ...
  if(G4TPC::ENABLE_AVERAGE_CORRECTIONS)
    {
      ...
      silicon_match->window_dy.set_QoverpT_maxabs({2.0,0,0});
      silicon_match->window_dz.set_posQoverpT_maxabs({0.854,0.3019,0.83});
      silicon_match->window_dz.set_negQoverpT_maxabs({0.560,0.4790,0.65});
      silicon_match->set_crossing_deltaz_max(20);
      silicon_match->set_crossing_deltaz_min(1.5);
